...
public class SearchResultActivity extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		imageUrls = new String[1000]; //bundle.getStringArray(Extra.IMAGES);
		for(int i = 0; i < 1000; ++i)
    	{
    		...
    		imageUrls[i]	= "http://www.cubiculus.com/images/54" + j;
    	}
...
/*	private Button showSet456;
	private Button showSet123;
	private String sqlRequest;
	private GridView gridViewLegoSets;
	...
	public class GridViewAdapter extends BaseAdapter
	{
	 ...
	 // references to our images
	    ...
	    public GridViewAdapter(Context c, String[] zzz)
	    {
	    	mThumbIds=zzz;
	    	imageLoader = ImageLoader.getInstance();
	    ...
	    @Override
		public int getCount() {
	    	//Tools.shortToast(getApplicationContext(), "getCount " + mThumbIds.length);
	    ...
	    @Override
		public View getView(int position, View convertView, ViewGroup parent) {
Tools.shortToast(getApplicationContext(), "Position is " + position + ", image URL is " + mThumbIds[position]);
	    	View page;

	        if (convertView == null)
	        {
	        	page	= inflater.inflate(R.layout.layout_search_result_lego_set, null);

	        	// We must defined a COMMON height because GridView has a bug if cells have different heights !
	        	page.setLayoutParams(new AbsListView.LayoutParams(gridViewLegoSets.getColumnWidth(),gridViewLegoSets.getColumnWidth()));
		    	...
		    	imageLoader.displayImage(mThumbIds[position], imgDisp, options, new SimpleImageLoadingListener()
				{
					@Override
					public void onLoadingStarted(String imageUri, View view)
					{
	        	...
	        	//Tools.shortToast(getApplicationContext(), "page = convertView");
	            page	= convertView;
	        }
